    ...
    <div className="shadow-md">
      ...
      <div className='bg-primary/40 py-2 lg:py-4 dark:bg-gray-900 dark:text-white shadow-xl  duration-200 relative z-40'>
        <div className='w-full flex-col py-5 px-10 lg:container lg:flex justify-between lg:items-center lg:flex-row'>
          <div className='mb-5'>
            <a href="/#" className='font-bold lg:text-4xl sm:text-2xl flex gap-x-2 lg:hover:scale-125 hover:scale-75 ease-in-out duration-500'>
          ...
          <div className='flex justify-between gap-4 items-center'>
            ...
            <button onClick={()=>handlePopup()} className="bg-gradient-to-r from-primary to-secondary text-white rounded-full py-1 px-4 transition-all duration-200 group gap-3 flex items-center ">
      ...
      <div className='flex justify-center bg-white text-black dark:bg-secondary dark:text-white'>
        <ul className='flex gap-4 lg:gap-20 items-center shadow-xl '>
          {
              Menu.map((data)=>(
                <li data-aos='zoom-in'
            data-aos-offset='100'
