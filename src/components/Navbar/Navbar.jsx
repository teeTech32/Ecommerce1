        ...
        <div className='w-full flex-col py-5 pl-2 pr-10 lg:container lg:flex justify-between lg:items-center lg:flex-row'>
          ...
          <div className='flex gap-2 md:gap-4 lg:gap-6 items-center'>
            <div className='group relative '>
              <input type="text" placeholder='search' className=' sm:w-[100px] lg:w-[300px] group-hover:w-[250px] lg:group-hover:w-[400px] transition-all duration-300 rounded-full border border-gray-300 px-2 py-1 lg:px-4 lg:py-2 focus:outline-none focus:border-1 focus:border-primary dark:text-black' />
